        ...
        <div class="container">
                        ...
                        <table class="table-dark" style="width: 1100px">
                            ...
                            <tbody>
                                ...
                                @if ($cartProducts->count() > 0)
                                    ...
                                    @endforeach
                                @else
                                    <p class="alert alert-success">You have no products in cart yet</p>
                                @endif
            ...
            <div class="row justify-content-end">
                <div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
                    ...
                    @else
                        <p class="text-center alert alert-success">You cannot chekout because you have no items in the cart
                        </p>
                    @endif
                </div>
            </div>
